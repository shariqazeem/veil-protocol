...
import { HeroAnimations, AnimatedSection, AnimatedCard, AnimatedTechTag } from "@/components/LandingAnimations";
    ...
    <div className="min-h-screen bg-white overflow-hidden relative">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 px-4 sm:px-6 py-4 sm:py-5 bg-white/90 backdrop-blur-xl border-b border-gray-200/60">
        <div className="max-w-5xl mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <Link href="/app">
              <button
                className="btn-shimmer px-5 py-2.5 bg-gray-900 text-white rounded-xl text-[13px] font-bold tracking-tight cursor-pointer flex items-center gap-2 shadow-lg hover:-translate-y-px transition-transform"
              >
                Launch App
      ...
      <section className="relative pt-32 sm:pt-44 pb-20 sm:pb-28 px-4 sm:px-6">
        <div className="max-w-3xl mx-auto text-center relative">
          ...
          <h1
            className="text-[36px] sm:text-[64px] font-black tracking-tight text-gray-900 leading-[1.05] mb-5 animate-fade-in-up"
          ...
          <p
            className="text-[15px] sm:text-[18px] text-gray-500 max-w-xl mx-auto mb-4 leading-relaxed animate-fade-in-up"
          ...
          <div
            className="flex flex-wrap items-center justify-center gap-x-6 gap-y-2 mb-8 animate-fade-in-up"
          ...
          >
            <Link href="/app">
              <button
                className="btn-shimmer px-8 py-4 bg-gray-900 text-white rounded-2xl text-[15px] font-bold tracking-tight cursor-pointer flex items-center gap-2 shadow-xl hover:-translate-y-0.5 transition-transform"
              >
          ...
          {[
            {
              ...
              color: "#4D4DFF", bg: "from-indigo-50 to-white", border: "border-indigo-200",
              tag: "Intelligence",
            },
            {
              ...
              color: "#FF9900", bg: "from-orange-50 to-white", border: "border-orange-200",
              tag: "Monetization",
            },
            {
              ...
              color: "#12D483", bg: "from-emerald-50 to-white", border: "border-emerald-200",
              tag: "Cryptography",
            },
          ].map((pillar, i) => (
            <AnimatedCard key={pillar.title} delay={i * 0.1}>
              <div className={`rounded-3xl border-2 ${pillar.border} bg-gradient-to-br ${pillar.bg} p-6 hover:shadow-2xl hover:-translate-y-3 transition-all h-full`}>
          ...
          <AnimatedSection>
            <div className="rounded-3xl border-2 border-orange-200 bg-gradient-to-br from-white to-orange-50/30 p-6 sm:p-10 shadow-sm hover:shadow-2xl transition-shadow">
              ...
              <p className="text-[13px] text-gray-500 leading-relaxed mb-6">
                The first privacy protocol with native micropayment-gated AI intelligence. No subscriptions, no accounts &mdash; just HTTP 402.
              </p>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-4 gap-3 mb-6">
                {[
                  ...
                  <div
                    key={s.step}
                    className="rounded-xl bg-white border border-gray-200 p-4 text-center hover:shadow-lg hover:-translate-y-1 transition-all"
                  >
          ...
          <AnimatedSection>
            <div className="rounded-3xl border-2 border-indigo-200 bg-gradient-to-br from-white to-indigo-50/30 p-6 sm:p-10 shadow-sm hover:shadow-2xl transition-shadow">
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="ml-auto text-[10px] font-bold uppercase tracking-wider px-2.5 py-1 rounded-full bg-indigo-50 text-[#4D4DFF] border border-indigo-200">
                  Natural Language
                </span>
              </div>
              <p className="text-[13px] text-gray-500 leading-relaxed mb-6">
                Tell the AI how you want to accumulate BTC. It analyzes live pool conditions, anonymity sets, BTC price, and timing &mdash; then generates an optimal strategy. One-click execution via connected wallet.
              </p>
              ...
              <div className="rounded-xl bg-gray-50 border border-gray-200 p-4">
                ...
                <div className="flex flex-wrap gap-2">
                  {[
                    ...
                    <span key={p} className="text-xs font-['JetBrains_Mono'] text-gray-600 px-3 py-1.5 rounded-lg bg-white border border-gray-200">
                      {p}
                    </span>
                  ))}
                </div>
            ...
            {[
              {
                ...
                color: "#4D4DFF", bg: "from-indigo-50 to-white", border: "border-indigo-100",
              },
              {
              ...
              },
              {
                ...
                color: "#12D483", bg: "from-emerald-50 to-white", border: "border-emerald-100",
              },
              {
              ...
              },
              {
                ...
                color: "#FF9900", bg: "from-orange-50 to-white", border: "border-orange-100",
              },
            ].map((step, i) => (
              <AnimatedCard key={step.title} delay={i * 0.08}>
                <div className={`rounded-2xl border-2 ${step.border} bg-gradient-to-br ${step.bg} p-4 text-center hover:shadow-2xl hover:-translate-y-3 transition-all h-full`}>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-1.5">
                    {[
                      ...
                      <div key={step} className="flex items-center gap-2">
                        <span className="text-[10px] font-['JetBrains_Mono'] text-emerald-400 w-3">{i + 1}.</span>
                ...
                <div className="rounded-xl bg-orange-50 border border-orange-100 p-4">
                  <div className="flex items-center gap-1.5 mb-3">
                    ...
                    <span className="text-xs font-bold text-orange-700">x402 Payment Flow</span>
                  </div>
                  <div className="space-y-1.5">
                    {[
                      ...
                      <div key={step} className="flex items-center gap-2">
                        <span className="text-[10px] font-['JetBrains_Mono'] text-orange-400 w-3">{i + 1}.</span>
                        <span className="text-[11px] text-orange-700 font-medium">{step}</span>
                      </div>
                    ))}
                  </div>
                </div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              ...
              <AnimatedCard key={feat.title} delay={i * 0.05}>
                <div className="p-5 rounded-2xl bg-white border-2 border-gray-100 hover:border-gray-200 hover:shadow-2xl hover:-translate-y-3 transition-all h-full">
          ...
          <AnimatedSection>
            <div className="rounded-3xl border-2 border-emerald-100 bg-gradient-to-br from-white to-emerald-50/20 p-6 sm:p-8 shadow-sm">
              ...
              <p className="text-xs text-gray-500 leading-relaxed mb-5">
                Real USDC, real WBTC, real AVNU integration, real Garaga ZK verification. Not a testnet demo &mdash; production infrastructure handling real assets with AI strategy and x402 payments.
              </p>
              <div className="flex flex-wrap gap-2">
                <a
          ...
          <div className="rounded-3xl border-2 border-gray-100 bg-white p-6 sm:p-8 shadow-sm">
            ...
            <div className="flex flex-wrap items-center justify-center gap-x-3 gap-y-2.5">
              {[
                ...
                "Merkle Trees", "Next.js", "sats-connect", "snforge", "37 Cairo Tests",
              ].map((tech, i) => (
                <AnimatedTechTag key={tech} delay={i * 0.03}>
                  <span className="text-[12px] font-['JetBrains_Mono'] font-medium text-gray-600 px-3 py-1.5 rounded-lg bg-gray-50 border border-gray-200 hover:bg-gray-100 hover:border-gray-300 transition-all cursor-default">
                    {tech}
                  </span>
                </AnimatedTechTag>
              ))}
      ...
      <section className="px-4 sm:px-6 pb-20 sm:pb-32 relative">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <Link href="/app">
            <button
              className="btn-shimmer px-8 py-4 bg-gray-900 text-white rounded-2xl text-[15px] font-bold tracking-tight cursor-pointer flex items-center gap-2 mx-auto shadow-xl hover:-translate-y-0.5 transition-transform"
            >
              <Brain size={16} strokeWidth={1.5} />
              Launch App
              <ArrowRight size={14} strokeWidth={2} />
