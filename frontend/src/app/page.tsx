...
function ScrambleText({ text, delay = 400 }: { text: string; delay?: number }) {
  ...
  useEffect(() => {
    // Immediately scramble on mount (client-only) to avoid hydration mismatch
    ...
    <div className="min-h-screen bg-white overflow-hidden relative">
          ...
          <div className="flex items-center gap-4">
            ...
            <Link href="/app">
              <motion.button
                ...
                whileHover={{ y: -1, boxShadow: "0 20px 40px -8px rgba(77,77,255,0.2)" }}
                whileTap={{ scale: 0.97 }}
      ...
      <section className="relative pt-32 sm:pt-44 pb-20 sm:pb-28 px-4 sm:px-6">
        <motion.div
          animate={{
            background: [
              'radial-gradient(circle at 20% 50%, rgba(77, 77, 255, 0.08) 0%, transparent 50%)',
              'radial-gradient(circle at 80% 50%, rgba(255, 153, 0, 0.06) 0%, transparent 50%)',
              'radial-gradient(circle at 50% 80%, rgba(18, 212, 131, 0.06) 0%, transparent 50%)',
              'radial-gradient(circle at 20% 50%, rgba(77, 77, 255, 0.08) 0%, transparent 50%)',
            ],
          }}
        ...
        <div className="max-w-3xl mx-auto text-center relative">
          <motion.div
            ...
            transition={{ y: springDefault, opacity: { duration: 0.6 } }}
          >
          ...
          <motion.h1
            ...
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ y: springDefault, opacity: { duration: 0.6, delay: 0.1 } }}
          >
          ...
          <motion.p
            ...
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ y: springDefault, opacity: { duration: 0.6, delay: 0.2 } }}
          >
          ...
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ y: springDefault, opacity: { duration: 0.6, delay: 0.25 } }}
          ...
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ y: springDefault, opacity: { duration: 0.6, delay: 0.3 } }}
          ...
          >
            <Link href="/app">
              <motion.button
                ...
                whileHover={{ y: -2, boxShadow: "0 20px 60px -12px rgba(77,77,255,0.25)" }}
                whileTap={{ scale: 0.97 }}
                transition={springSnappy}
              >
        ...
        >
          {[
            ...
            <motion.div
              ...
              whileHover={{ y: -12, transition: springSnappy }}
              className={`rounded-3xl border-2 ${pillar.border} bg-gradient-to-br ${pillar.bg} p-6 hover:shadow-2xl transition-shadow`}
            >
      ...
      <section className="px-4 sm:px-6 pb-20 sm:pb-24 relative">
        <div className="max-w-4xl mx-auto">
          <motion.div
            className="rounded-3xl border-2 border-orange-200 bg-gradient-to-br from-white to-orange-50/30 p-6 sm:p-10 shadow-sm hover:shadow-2xl transition-shadow"
            ...
            <div className="grid grid-cols-1 sm:grid-cols-4 gap-3 mb-6">
              {[
                ...
                <motion.div
                  ...
                  className="rounded-xl bg-white border border-gray-200 p-4 text-center hover:shadow-lg transition-shadow"
                >
      ...
      <section className="px-4 sm:px-6 pb-20 sm:pb-24 relative">
        <div className="max-w-4xl mx-auto">
          <motion.div
            className="rounded-3xl border-2 border-indigo-200 bg-gradient-to-br from-white to-indigo-50/30 p-6 sm:p-10 shadow-sm hover:shadow-2xl transition-shadow"
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            transition={{ duration: 0.7 }}
          ...
          >
            {[
              ...
              <motion.div
                ...
                variants={itemVariants}
                whileHover={{ y: -12, transition: springSnappy }}
                className={`rounded-2xl border-2 ${step.border} bg-gradient-to-br ${step.bg} p-4 text-center hover:shadow-2xl transition-shadow`}
              >
          ...
          >
            {[
              ...
              <motion.div
                ...
                variants={itemVariants}
                whileHover={{ y: -12, transition: springSnappy }}
                className="p-5 rounded-2xl bg-white border-2 border-gray-100 hover:border-gray-200 hover:shadow-2xl transition-shadow"
              >
          ...
          <div className="rounded-3xl border-2 border-gray-100 bg-white p-6 sm:p-8 shadow-sm">
            ...
            <div className="flex flex-wrap items-center justify-center gap-x-3 gap-y-2.5">
              {[
                ...
                <motion.span
                  key={tech}
                  className="text-[12px] font-['JetBrains_Mono'] font-medium text-gray-600 px-3 py-1.5 rounded-lg bg-gray-50 border border-gray-200 hover:bg-gray-100 hover:border-gray-300 transition-all cursor-default"
