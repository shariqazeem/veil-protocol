...
use super::honk_verifier_circuits::{
    is_on_curve_excluding_infinity_bn254, run_GRUMPKIN_ZKHONK_PREP_MSM_SCALARS_SIZE_11_circuit,
...
mod UltraKeccakZKHonkVerifier {
    ...
    use super::{
        ...
        run_GRUMPKIN_ZKHONK_PREP_MSM_SCALARS_SIZE_11_circuit,
        run_GRUMPKIN_ZK_HONK_EVALS_CONS_DONE_SIZE_11_circuit,
        run_GRUMPKIN_ZK_HONK_EVALS_CONS_INIT_SIZE_11_circuit,
        run_GRUMPKIN_ZK_HONK_EVALS_CONS_LOOP_SIZE_11_circuit,
    ...
    impl IUltraKeccakZKHonkVerifier of super::IUltraKeccakZKHonkVerifier<ContractState> {
        fn verify_ultra_keccak_zk_honk_proof(
            ...
            let mut scalars: Span<u384> = array![
                ...
                transcript.shplonk_z.into(), scalar_51,
            ]
                .span();

            // Check input points are on curve.
            // Skip the first 28 points as they are from VK and keep the last 23 proof points
            for point in points.slice(28, 23) {
                assert(
